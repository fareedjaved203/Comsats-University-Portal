...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('css/quizDashboard.css') }}" rel="stylesheet">
    <link
          ...
          <div class="col-md d-flex align-items-center justify-content-center">
            <div class="body d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book-open-reader fa-4x"
                ><br />
                <p style="font-size: 25px; margin-top: 20px">Quiz 1</p>
              </i>
            </div>
          </div>
          <div class="col-md d-flex align-items-center justify-content-center">
            <div class="body d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book-open-reader fa-4x"
                ><br />
                <p style="font-size: 25px; margin-top: 20px">Quiz 2</p>
              </i>
            </div>
          </div>
          <div class="col-md d-flex align-items-center justify-content-center">
            <div class="body d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book-open-reader fa-4x"
                ><br />
                <p style="font-size: 25px; margin-top: 20px">Quiz 3</p>
              </i>
            </div>
          </div>
          <div class="col-md d-flex align-items-center justify-content-center">
            <div class="body d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book-open-reader fa-4x"
                ><br />
                <p style="font-size: 25px; margin-top: 20px">Quiz 4</p>
              </i>
            </div>
          </div>
        </div>
      ...
      btn.forEach((item, index) => {
        ...
        item.addEventListener("click", () => {
          return window.location.assign(
            "{{ url('/home/courseInfo/quizDashboard/quiz') }}"
        );
        });
      });
    </script>
