...
<body class="d-flex flex-column min-vh-100">
    <div id="mySidebar" class="sidebar bg-white text-dark">
        ...
        <div class="text-dark">
                <a href="{{ url('/admin_dashboard/lecturer_details') }}"class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <span class="las la-chalkboard-teacher"></span>
                    <i class="fas fa-tachometer-alt fa-fw me-3"></i><span >Lecturer</span>  
                </a>
                <a href="/admin_dashboard/student_details"class="list-group-item list-group-item-action py-2 ripple " aria-current="true">
                    <span class="las la-user"></span>
                    <i class="fas fa-tachometer-alt fa-fw me-3"></i><span >Students</span>  
                </a>
                <a href="/admin_dashboard/course_details"class="list-group-item list-group-item-action py-2 ripple " aria-current="true">
                ...
                <a href="{{ url('/admin_dashboard/contact') }}"class="list-group-item list-group-item-action py-2 ripple " aria-current="true">
        ...
        <main>
            <div class="page-header">
                ...
                <div class="header-actions ">
                    <a style="text-decoration: none; color:white;" href="{{ url('/admin') }}">
                        <button>
                ...
                <div class="cards-single">
                    <div class="cards-flex">
                        <div class="cards-info">
                            ...
                            <h2>{{$teacher}}</h2>
                            <small>5% increses in 28 Days</small>
                        </div>
                        <div class="cards-chart yellow">
                            <span class="las la-chart-line"></span>
                        </div>
                    </div>
                </div>
