...
html{
  ...
  <div class="container img-section">
    ...
    <div class="container bottom-container text-center" style="margin-top: 150px !important">
      <i class="fa-solid fa-square-check fa-5x" style="color: darkgreen;"> <br> <span style="font-size: 30px; "> Your Response is Successfully Submitted</span></i>
    </div>
    <footer
