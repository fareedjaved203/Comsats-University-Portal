...
html{
      ...
      .player-thumb {
        ...
        border-radius: 50%;
        background-image: url("student/{{$student->image}}");
    ...
    <div class="row text-center">
      <div class="col-md-8">
        <p class="h1 mt-5 welcome" style="color: black;">
          ...
          <div class="enrollBtn">
            <a href="courses.html" class="enrollCourse"><button class="btn btn-success" style="font-size: 2rem;">Enroll Course</button> </a>
          </div>
        </p>
      </div>
      <div class="col-md-4">
