...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('css/teacherlogin.css') }}" rel="stylesheet">
  ...
  <div class="main w-100 border border-5 rounded-3 overflow-hidden" style="height: 80%;">
        <div class="row text-center w-100" style="height: 100%">
          ...
          <div class="col-md-7 login-side-text">
            ...
            <div class="heading-1 fw-bold">LECTURER'S LOGIN</div>
            @if (Session::has('error'))
                <div class="alert alert-danger">{{ Session::get('error') }}</div>
            @endif
            <form action="/Teacherlogin" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    <div class="col-md-12">
                        <input type="email" name="email" class="inp px-4" placeholder= "&#xf007;   Email" style="font-family: 'Font Awesome 6 Free'; font-weight: 700; font-size: 15px;" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12">
            ...
            <p class="d-block d-sm-none"><a href="{{ url('/Teacherregister') }}" style="color: grey;">New Here? Sign Up Now</a></p>
        </div>
        <div
          ...
          >
            ...
            <a href="{{ url('/Teacherregister') }}"><button class="btn1 btn2">Sign Up</button></a>
          </div>
      </div>
    </div>
    <script
